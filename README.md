<h1 align="center">Kyle Tredway</h1>
<h3 align="center">Solidity Developer · Token Infrastructure Specialist</h3>

<p align="center">
  <a href="https://tredwaydev.com">Website</a> ·
  <a href="https://twitter.com/kyletredwaydev">Twitter</a> ·
  <a href="https://fiverr.com/kyletredwaydev">Fiverr</a>
</p>
...
I build production-ready ERC-20 token infrastructure for Web3 projects: from token launch to full on-chain governance. Every contract is tested, Sepolia deployed, and Etherscan verified.

Currently available for freelance work. View my packages at [tredwaydev.com](https://tredwaydev.com).

---

## Token Infrastructure Suite
...
![OpenZeppelin](https://img.shields.io/badge/OpenZeppelin-4A90E2?style=flat)
...
**LayerLaunch** : A Web3 SaaS platform that automates the full ERC-20 token infrastructure stack.
